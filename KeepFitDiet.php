<?php
			...
			//Button that triggers redirection of page
			 if(isset($_POST["submit1"])){
					 		header("location: Abs_Diet.php");
					 }


				 elseif (isset($_POST["submit2"])) {
				 		 header("location: Chest_Diet.php");
				 }


				 elseif (isset($_POST["submit3"])) {
				 		 header("location: Biceps_Diet.php");
				 }


				 elseif (isset($_POST["submit4"])) {
				 		 header("location: Calves_Diet.php");
				 }


				 elseif (isset($_POST["submit5"])) {
				 		 header("location: Glutes_Diet.php");
				 }

				 elseif (isset($_POST["submit6"])) {
				 		 header("location: All-round_Diet.php");
				 }
