...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended exercises to improve Cancer</p>
	...
	<?php
		...
		$query = "SELECT contributors.name, health.Cancer FROM health LEFT JOIN contributors ON health.contributor_id = contributors.id  WHERE health.healthid = 'HE'";
