...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended exercises to get a full body workout!</p>
  	...
  	<?php
		...
		$query = "SELECT contributors.name, keepfit.all_round FROM keepfit LEFT JOIN contributors ON keepfit.contributorid = contributors.id  WHERE keepfit.keepfitid = 'KFE'";
