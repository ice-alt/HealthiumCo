...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended exercises to get the Glutes of your dreams!</p>
  	...
  	<?php
		...
		$query = "SELECT contributors.name, keepfit.glutes FROM keepfit LEFT JOIN contributors ON keepfit.contributorid = contributors.id  WHERE keepfit.keepfitid = 'KFE'";
