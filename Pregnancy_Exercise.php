...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended exercises to improve your Pregnancy</p>
	...
	<?php
		...
		$query = "SELECT contributors.name, health.Pregnancy FROM health LEFT JOIN contributors ON health.contributor_id = contributors.id  WHERE health.healthid = 'HE'";
