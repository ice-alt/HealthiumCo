...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended diets to get an all-round healthier body!</p>
	...
	<?php
		...
		$query = "SELECT contributors.name, keepfit.all_round FROM keepfit LEFT JOIN contributors ON keepfit.contributorid = contributors.id  WHERE keepfit.keepfitid = 'KFD'";
