...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended diets to improve Diabetes</p>
	...
	<?php
		...
		$query = "SELECT contributors.name, health.Arthritis FROM health LEFT JOIN contributors ON health.contributor_id = contributors.id  WHERE health.healthid = 'HD'";
