...
<head>
	...
	<body>
		...
		<p class="descriptiontext">Try out these recommended diets to get the Chest of your dreams!</p>
	...
	<?php
		...
		$query = "SELECT contributors.name, keepfit.chest FROM keepfit LEFT JOIN contributors ON keepfit.contributorid = contributors.id  WHERE keepfit.keepfitid = 'KFD'";
